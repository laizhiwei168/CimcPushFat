...
public class DataLogUtil {
    ...
    public void SaveGetValve(String command_str){
    	String date=df.format(new Date());
    	String path="/SaveGetValve";
    	String filtname="saveGetValve_"+date+".log";
    	try {
    ...
    public void SaveSetValve(String command_str){
    	String date=df.format(new Date());
    	String path="/SaveSetValve";
    	String filtname="saveSetValve_"+date+".log";
    	try {
			this.writelog_to_txt(path,filtname, command_str);
		} catch (IOException e) {
			e.printStackTrace();
    ...
    public void SaveSenHedata(String fenceEventCommand_str){
    	String date=df.format(new Date());
    	String path="/SenHedata";
    	String filtname="senHedata_"+date+".log";
    	try {
			this.writelog_to_txt(path,filtname, fenceEventCommand_str);
		} catch (IOException e) {
			e.printStackTrace();
