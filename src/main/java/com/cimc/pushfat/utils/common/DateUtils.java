package com.cimc.pushfat.utils.common;
...
public class DateUtils {
	...
	public static String datetime2datetime(String BCDdatetime){
		DateFormat dFormat1 = new SimpleDateFormat("yyyyMMddHHmmssSSS");
		Date dt = null;
		try {
			dt = dFormat1.parse(BCDdatetime);
		} catch (ParseException e) {
		...
		DateFormat dFormat2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS"); 
		String formatDate = dFormat2.format(dt); 
        return formatDate;
	}
