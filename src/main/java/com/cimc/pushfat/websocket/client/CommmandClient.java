...
public class CommmandClient {
    ...
    private CommmandClient() {    	
    }
    
    private static CommmandClient commmandClient=new CommmandClient();
    
    public static CommmandClient getCommmandClient() {
    	return commmandClient;
    }
