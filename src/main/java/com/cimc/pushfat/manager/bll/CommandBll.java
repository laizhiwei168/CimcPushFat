...
import com.cimc.pushfat.manager.dal.CommandDal;
...
public class CommandBll {
	...
	public int updateTFCommand(Full_commandPo full_command){
		return commandDal.updateTFCommand(full_command);
	}
	...
	public List<Map<String, Object>> selectcammandByIDAndFlowidToList(Full_commandPo full_command){
		return commandDal.selectcammandByIDAndFlowid(full_command);
	}
}
